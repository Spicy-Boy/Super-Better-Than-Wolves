...
public class FCBlockWorkbench extends BlockWorkbench
{
	...
	public boolean DropComponentItemsOnBadBreak( World world, int i, int j, int k, int iMetadata, float fChanceOfDrop )
	{
		...
		DropItemsIndividualy( world, i, j, k, Item.stick.itemID, 5, 0, fChanceOfDrop );
		DropItemsIndividualy( world, i, j, k, FCBetterThanWolves.fcItemNuggetIron.itemID, 7, 0, fChanceOfDrop );
