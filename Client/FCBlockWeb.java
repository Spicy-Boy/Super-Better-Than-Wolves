...
public class FCBlockWeb extends BlockWeb
{
    ...
    {
    	if ( stack != null && stack.getItem() instanceof FCItemChisel || stack.getItem() instanceof SuperBTWItemBlade)
    	{
    		if (stack.getItem() instanceof FCItemChisel)
    		{
    		...
    		else if (stack.getItem() instanceof SuperBTWItemBlade)
    		{
    			return true;
    		}
